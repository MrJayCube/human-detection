...
// finalProject.cpp: define los comportamientos de las clases para la aplicación.
//
...
// Construcción de CfinalProjectApp
...
// Único objeto CfinalProjectApp

CfinalProjectApp theApp;


// Inicialización de CfinalProjectApp
